                                        ...
                                        <div className="flex flex-col items-center justify-center text-center">
                                            ...
                                            <h3 className="text-lg lg:text-xl font-bold text-[#23223a] mb-3">
                                                {activeTab === 'deposits' ? (
                                                    ...
                                                    <>Aún no hay solicitudes para <br /> recibir ganancias</>
                                                )}
                                            </h3>
                                            {/* Description */}
                                            <p className="text-sm lg:text-sm text-gray-400 mb-6">
                                                {activeTab === 'deposits' ? (
                                                    <>Recarga tu cuenta, realiza apuestas <br /> y obtén ganancias!</>
                                                ) : (
                                                    <>Las solicitudes de ganancias <br /> se mostrarán aquí</>
                                                )}
                                            </p>
                                            {/* Button */}
                                            <button 
                                                ...
                                                onClick={() => window.location.href = activeTab === 'deposits' ? '/deposit' : '/withdrawal'}
                                            >
                                                {activeTab === 'deposits' ? 'Recargar' : 'Obtener una ganancia'}
                                            </button>
                                        </div>
                                    </td>
                                </tr>
