    ...
    <footer className="mt-2 px-4">
      ...
      <div className="px-4 md:px-8 py-4 md:py-6 bg-white rounded-lg shadow-lg mt-5">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <div>
            <Link
              href="/policies?tab=general-terms"
              className="text-gray-600 hover:text-gray-800 text-xs text-left"
            >
          ...
          <div>
            <Link
              href="/policies?tab=responsible-gaming"
              className="text-gray-600 hover:text-gray-800 text-xs text-left"
            >
          ...
          <div>
            <Link
              href="/policies?tab=affiliate-program"
              className="text-gray-600 hover:text-gray-800 text-xs text-left"
            >
          ...
          <div>
            <Link
              href="/policies?tab=account-payments"
              className="text-gray-600 hover:text-gray-800 text-xs text-left"
            >
      ...
      <div className="px-4 md:px-8 py-4 md:py-6">
        <div className="grid grid-cols-3 md:flex md:justify-center md:items-center gap-3 md:gap-6">
          <img
            src="/images/payment-methods/307b7b315b7597e6513c760304c7c94fe003e175.png"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/327e939dab2ca92f266aebd9b7243ce38582e17d.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/33efc8ead2414bf349ca93bcb62d3f7ad925ad88.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/397f7bdb61cef2095cc631cf2f1badff6036e860.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/5a63e45e802d93da96a501216c32e1409ff85913.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/72698307473a26ea6b15973628f47d7739283ba6.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/7ae673bfb8eb4cb84305ad9d4901e2b5ba4485c6.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/8244c9f24968b8fe98f63426d8f082fed00959f2.png"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/9f64cca67d82187701c87f3b5c3e2850a7d8c74d.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/c597fb320ff5ae4add7a6549d0bce15970773f8f.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/c9ddf68a7b7be62b1b5142978d6bbf8626dade69.png"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
          <img
            src="/images/payment-methods/e4d15b3adf888755bb668d654f9b4e1a5163998c.webp"
            alt="payment method"
            className="h-12 md:h-16 w-20 md:w-32 border border-gray-300 rounded-lg p-1 object-contain"
          />
        </div>
