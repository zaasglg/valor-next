          ...
          <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <h2 className="text-xl md:text-2xl font-bold mr-5">Casino</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="hidden md:flex gap-2 text-sm">
                <span className="bg-gray-100 px-2 py-1 rounded-2xl cursor-pointer">Crash</span>
                <span className="bg-gray-100 px-2 py-1 rounded-2xl cursor-pointer">Valor Games</span>
                <span className="bg-gray-100 px-2 py-1 rounded-2xl cursor-pointer">All Games</span>
              </div>
              <Link
                href="/all_games"
                className="bg-white text-gray-700 text-xs md:text-sm flex items-center gap-1 px-3 py-2 rounded-lg border-0 shadow-[0_4px_0_0_#6b46c1] hover:shadow-[0_2px_0_0_#6b46c1] active:shadow-[0_1px_0_0_#6b46c1] active:translate-y-1 transition-all duration-100"
