  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        ...
        <DialogContent className="max-w-sm md:max-w-2xl mx-auto p-0 overflow-hidden">

          <DialogHeader className="bg-green-600 text-white p-4">
            <DialogTitle className="text-white text-xl">{t('register.title')}</DialogTitle>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            {error && (
              <div className="col-span-1 md:col-span-2 p-3 bg-red-100 border border-red-400 text-red-700 rounded">
                {error}
              </div>
            )}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">{t('register.country')}</label>
            ...
            <div className="flex items-end">
              ...
              >
                {isLoading ? t('register.creating_account') : t('register.open_account')}
              </Button>
            </div>
          </form>
          ...
          <div className="my-6 md:my-10 px-4 md:px-0">
            <p className="text-xs text-center text-gray-600">
              {t('register.terms_agreement')} <span className="text-blue-600">{t('register.terms_link')}</span>
            </p>
          </div>

          <div className="bg-green-600 text-white p-3 md:p-4 rounded-t-2xl">
            <div className="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 text-center text-xs md:text-sm">
              <div>
                ...
                <p className="text-xs">{t('register.bonus_bets')}</p>
              </div>
              <div>
                <div className="mb-2 flex justify-center">
                ...
                <p className="text-xs">{t('register.bonus_casino')}</p>
              </div>
              <div>
                <div className="mb-2 flex justify-center">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="text-xs">{t('register.bonus_cashback')}</p>
              </div>
            </div>
          </div>

          <div className="bg-gray-800 text-white p-3 md:p-4 flex justify-between items-center gap-2 md:gap-0">
            <span className="text-sm md:text-base">{t('register.have_account')}</span>
            <span
              className="text-white font-bold cursor-pointer text-sm md:text-base"
